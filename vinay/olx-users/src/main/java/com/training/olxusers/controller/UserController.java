package com.training.olxusers.controller;
...
import com.training.olxusers.service.UserService;
...
public class UserController {
	...
	//url:http://localhost:9003/api/v1/user/adduser
	@PostMapping("/adduser")
	...
	//url:http://localhost:9003/api/v1/user/2
	@GetMapping("/{userId}")
	...
	//url:http://localhost:9003/api/v1/user/deleteuser/2
